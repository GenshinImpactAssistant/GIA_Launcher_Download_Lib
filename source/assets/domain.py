...
TextDomainExit = Text(zh='退出秘境',en="Leave Domain",cap_area=AreaDomainFailure.position)
TextDomainRechallenge = Text(zh='再次挑战',en="Rechallenge",cap_area=AreaDomainFailure.position) #TODO: correct it